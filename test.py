...
# for S,V its 0-255.
cv2.createTrackbar("L - H", "Trackbars", 21, 179, nothing)
cv2.createTrackbar("L - S", "Trackbars", 128, 255, nothing)
cv2.createTrackbar("L - V", "Trackbars", 127, 255, nothing)
